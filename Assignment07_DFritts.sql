...
-- 2017-01-01,DFritts,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_DFritts')
	 Begin 
	  Alter Database [Assignment07DB_DFritts] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_DFritts;
	 End
	Create Database Assignment07DB_DFritts;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_DFritts;
...
--SELECT ProductName, '$' + Cast (UnitPrice AS varchar (100)) FROM Products;

SELECT ProductName, '$' + Cast (UnitPrice AS varchar (100)) AS UnitPrice FROM Products;
go
...
SELECT 
		C.CategoryName
		, P.ProductName
		, Price = '$' + Cast (P.UnitPrice AS varchar (100))
From vCategories as C
	Inner Join vProducts as P
	ON C.CategoryID = P.CategoryID
--SELECT ProductName, '$' + Cast (UnitPrice AS varchar (100)) AS UnitPrice FROM Products
...
-- <Put Your Code Here> -- Use Lag 2:42 into 3rd video
...
-- <Put Your Code Here> --8:38 in 3rd video for KPI
